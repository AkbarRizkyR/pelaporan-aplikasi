...
l=0;for(h=e.length;l<h;l++)if(c=e[l],b.isArray(c))q(d,c);else{g=f="";switch(c){case "ellipsis":f="&#x2026;";g="disabled";break;case "Awal":f=k.sFirst;g=c+(0<j?"":" disabled");break;case "Sebelum":f=k.sPrevious;g=c+(0<j?"":" disabled");break;case "Setelah":f=k.sNext;g=c+(j<n-1?"":" disabled");break;case "Akhir":f=k.sLast;g=c+(j<n-1?"":" disabled");break;default:f=c+1,g=j===c?"active":""}f&&(i=b("<li>",{"class":s.sPageButton+" "+g,id:0===r&&"string"===typeof c?a.sTableId+"_"+c:null}).append(b("<a>",{href:"#",
