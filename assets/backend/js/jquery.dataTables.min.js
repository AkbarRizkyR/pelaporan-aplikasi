...
sContentPadding:null,sDefaultContent:null,sName:null,sSortDataType:"std",sSortingClass:null,sSortingClassJUI:null,sTitle:null,sType:null,sWidth:null,sWidthOrig:null};m.defaults={aaData:null,aaSorting:[[0,"desc"]],aaSortingFixed:[],ajax:null,aLengthMenu:[10,25,50,100],aoColumns:null,aoColumnDefs:null,aoSearchCols:[],asStripeClasses:null,bAutoWidth:!0,bDeferRender:!1,bDestroy:!1,bFilter:!0,bInfo:!0,bJQueryUI:!1,bLengthChange:!0,bPaginate:!0,bProcessing:!1,bRetrieve:!1,bScrollCollapse:!1,bServerSide:!1,
...
oPaginate:{sFirst:"Awal",sLast:"Akhir",sNext:"Setelah",sPrevious:"Sebelum"},sEmptyTable:"<center>Data Tidak Ditemukan</center>",sInfo:"Menampilkan _START_ - _END_ dari _TOTAL_ Data",sInfoEmpty:"Menampilkan 0 - 0 dari 0 Data",sInfoFiltered:"(filtered from _MAX_ total Data)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Menampilkan _MENU_ Data",sLoadingRecords:"Mohon Menunggu...",sProcessing:"Sedang di Prosess...",sSearch:"Pencarian : ",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Tidak Menemukan Data yang Sesuai"},oSearch:h.extend({},
...
" ui-corner-bl ui-corner-br"});var Mb=m.ext.pager;h.extend(Mb,{simple:function(){return["Sebelum","Setelah"]},full:function(){return["Awal","Sebelum","Setelah","Akhir"]},numbers:function(a,b){return[Aa(a,b)]},simple_numbers:function(a,b){return["Sebelum",Aa(a,b),"Setelah"]},full_numbers:function(a,b){return["Awal","Sebelum",Aa(a,b),"Setelah","Akhir"]},_numbers:Aa,numbers_length:7});h.extend(!0,m.ext.renderer,{pageButton:{_:function(a,b,c,d,e,f){var g=a.oClasses,j=a.oLanguage.oPaginate,i=a.oLanguage.oAria.paginate||

{},k,l,m=0,p=function(b,d){var n,r,t,s,v=function(b){Ta(a,b.data.action,true)};n=0;for(r=d.length;n<r;n++){s=d[n];if(h.isArray(s)){t=h("<"+(s.DT_el||"div")+"/>").appendTo(b);p(t,s)}else{k=null;l="";switch(s){case "ellipsis":b.append('<span class="ellipsis">&#x2026;</span>');break;case "Awal":k=j.sFirst;l=s+(e>0?"":" "+g.sPageButtonDisabled);break;case "Sebelum":k=j.sPrevious;l=s+(e>0?"":" "+g.sPageButtonDisabled);break;case "Setelah":k=j.sNext;l=s+(e<f-1?"":" "+g.sPageButtonDisabled);break;case "Akhir":k=
